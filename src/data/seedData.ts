...
export const SEED_SCENARIOS: LearningScenario[] = (() => {
    // Shared 5-stage template — customize per scenario
    const makeStages = (objectives: string[][]): any[] => [
        { name: 'warm-up', label: 'Warm Up', description: 'Simple greetings and context setting', suggestedTurns: 2, objectives: objectives[0] || [], coachingIntensity: 'high' },
        { name: 'guided', label: 'Guided', description: 'Follow prompts with heavy assistance', suggestedTurns: 3, objectives: objectives[1] || [], coachingIntensity: 'high' },
        { name: 'challenge', label: 'Challenge', description: 'Handle unexpected questions', suggestedTurns: 3, objectives: objectives[2] || [], coachingIntensity: 'medium' },
        { name: 'natural-flow', label: 'Free Talk', description: 'Open conversation on topic', suggestedTurns: 3, objectives: objectives[3] || [], coachingIntensity: 'low' },
        { name: 'wrap-up', label: 'Wrap Up', description: 'Politely end the conversation', suggestedTurns: 2, objectives: objectives[4] || [], coachingIntensity: 'medium' },
    ];
    ...
    return [
        {
            ...
            stages: makeStages([
                ['Greet the waiter'],
                ['Ask for the menu', 'Order a drink'],
                ['Handle waiter asking about preferences'],
                ['Have a natural exchange about the food'],
                ['Request the bill', 'Say goodbye'],
            ]),
            prerequisiteLessonIds: ['lesson-ja-1-1'],
            estimatedMinutes: 5,
            maxTurns: 15,
            aiPersonality: 'Friendly, patient Japanese waiter named Takeshi',
            contextDescription: 'You just sat down at a cozy ramen shop in Shinjuku, Tokyo. The waiter approaches your table with a smile.',
        },
        {
            ...
            conversationMode: 'formal',
            stages: makeStages([
                ['Get attention with sumimasen'],
                ['Ask for a ticket to a destination'],
                ['Handle questions about one-way vs round trip'],
                ['Ask about platform and departure time'],
                ['Thank the attendant'],
            ]),
            prerequisiteLessonIds: ['lesson-ja-1-2'],
            estimatedMinutes: 5,
            maxTurns: 14,
            aiPersonality: 'Efficient but friendly station attendant named Yuki',
            contextDescription: 'You are at Shibuya Station trying to get to Asakusa. You approach the ticket counter.',
        },
        {
            id: 'scenario-fr-cafe',
            languageCode: 'fr',
            ...
            stages: makeStages([
                ['Say bonjour to the waiter'],
                ['Order a coffee and a pastry'],
                ['Answer questions about preferences'],
                ['Chat casually about the weather or city'],
                ['Ask for the bill and say goodbye'],
            ]),
            prerequisiteLessonIds: ['lesson-fr-1-1'],
            estimatedMinutes: 5,
            maxTurns: 14,
            aiPersonality: 'Charming, slightly hurried Parisian waiter named Pierre',
            contextDescription: 'You are seated at a small terrace table at Café de Flore in Paris. The morning sun is warm.',
        },
        {
            ...
            stages: makeStages([
                ['Say buenos días'],
                ['Ask about prices of fruits'],
                ['Handle the vendor offering other items'],
                ['Negotiate or ask about quality'],
                ['Pay and say goodbye'],
            ]),
            prerequisiteLessonIds: ['lesson-es-1-1'],
            estimatedMinutes: 5,
            maxTurns: 14,
            aiPersonality: 'Warm, enthusiastic market vendor named María',
            contextDescription: 'You are at La Boqueria market in Barcelona. Colorful fruits and vegetables surround you.',
        },
        {
            id: 'scenario-ja-hotel',
            languageCode: 'ja',
            title: 'Hotel Check-In',
            description: 'Check into a hotel and ask about amenities',
            icon: '🏨',
            difficulty: 'A1' as CEFRLevel,
            vocabularyIds: ['vocab-ja-9', 'vocab-ja-11', 'vocab-ja-12'],
            systemPrompt: 'You are a polite hotel receptionist in Japan. The user is learning Japanese. Help them check in, ask about their room, and learn about hotel amenities. Use simple A1-level Japanese. Provide romaji in parentheses.',
            objectives: ['Check in', 'Ask about WiFi', 'Ask about breakfast time'],
            suggestedResponses: ['予約があります (yoyaku ga arimasu)', 'WiFiはありますか？ (WiFi wa arimasu ka?)'],
            conversationMode: 'formal',
            stages: makeStages([
                ['Greet at reception'],
                ['Say you have a reservation'],
                ['Handle questions about ID and room preference'],
                ['Ask about hotel amenities'],
                ['Thank the receptionist'],
            ]),
            prerequisiteLessonIds: ['lesson-ja-1-3'],
            estimatedMinutes: 6,
            maxTurns: 16,
            aiPersonality: 'Very polite, professional hotel receptionist named Sakura',
            contextDescription: 'You arrive at a traditional ryokan hotel in Kyoto after a long journey. The lobby is elegant and quiet.',
        },
        {
            id: 'scenario-fr-pharmacy',
            languageCode: 'fr',
            title: 'At the Pharmacy',
            description: 'Buy medicine and describe symptoms in French',
            icon: '💊',
            difficulty: 'A1' as CEFRLevel,
            vocabularyIds: ['vocab-fr-1', 'vocab-fr-3', 'vocab-fr-6'],
            systemPrompt: 'You are a pharmacist in France. The user is learning French. Help them practice buying medicine and describing simple symptoms. Be patient and use A1-level vocabulary.',
            objectives: ['Describe a headache', 'Ask for medicine', 'Understand dosage instructions'],
            suggestedResponses: ['J\'ai mal à la tête', 'Avez-vous quelque chose pour...?'],
            conversationMode: 'formal',
            stages: makeStages([
                ['Enter and greet the pharmacist'],
                ['Describe your symptom'],
                ['Handle follow-up questions about the symptom'],
                ['Ask about dosage and side effects'],
                ['Thank and pay'],
            ]),
            prerequisiteLessonIds: ['lesson-fr-1-2'],
            estimatedMinutes: 5,
            maxTurns: 14,
            aiPersonality: 'Caring, knowledgeable pharmacist named Sophie',
            contextDescription: 'You have a headache and walk into a pharmacy on Rue de Rivoli in Paris.',
        },
    ];
})();
